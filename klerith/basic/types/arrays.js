...
(function () {
    ...
    console.log({ myArray1: myArray1 }); // { myArray1: [ 1, 2, 3, 4, 5 ] }
    ...
    var myArray2 = ["a", "b", "c"];
    console.log({ myArray2: myArray2 }); // { myArray2: [ 'a', 'b', 'c' ] }
    ...
    console.log({ myArray3: myArray3 }); // { myArray3: [ '1', 2, '3', 4, '5' ] }
    ...
    console.log({ myArray4: myArray4 }); // { myArray4: [ 1, 2, 3, 4, 5 ] }
    console.log(typeof myArray4); // object
    // Ok
    myArray4 = [6, 7, 8, 9, 10];
    console.log({ myArray4: myArray4 }); // { myArray4: [ 6, 7, 8, 9, 10 ] }
    console.log(typeof myArray4); // object
    ...
    var myArray5 = ["a", "b", "c"];
    console.log({ myArray5: myArray5 }); // { myArray5: [ 'a', 'b', 'c' ] }
    console.log(typeof myArray5); // object
    // Ok
    myArray5 = ["d", "e", "f"];
    console.log({ myArray5: myArray5 }); // { myArray5: [ 'd', 'e', 'f' ] }
    console.log(typeof myArray5); // object
    ...
    console.log({ myArray6: myArray6 }); // { myArray6: [ 1, 2, 3, 4, 5 ] }
    console.log(typeof myArray6); // object
    // Ok
    myArray6 = ["a", "b", "c"];
    console.log({ myArray6: myArray6 }); // { myArray6: [ 'a', 'b', 'c' ] }
    console.log(typeof myArray6); // object
    // Error:
    ...
    console.log({ myArray10: myArray10 }); // { myArray10: [ '1', 2, '3', 4, '5' ] }
    ...
    console.log({ myArray11: myArray11 }); // { myArray11: [ 1, 2, 3, 4, 5 ] }
    console.log(typeof myArray11); // object
    // Ok
    clearArray(myArray11);
    myArray11.push(6, 7, 8, 9, 10);
    console.log({ myArray11: myArray11 }); // { myArray11: [ 6, 7, 8, 9, 10 ] }
    console.log(typeof myArray11); // object
    ...
    var myArray12 = ["a", "b", "c"];
    console.log({ myArray12: myArray12 }); // { myArray12: [ 'a', 'b', 'c' ] }
    console.log(typeof myArray12); // object
    // Ok
    clearArray(myArray12);
    myArray12.push("d", "e", "f");
    console.log({ myArray12: myArray12 }); // { myArray12: [ 'd', 'e', 'f' ] }
    console.log(typeof myArray12); // object
    ...
    console.log({ myArray13: myArray13 }); // { myArray13: [ 1, 2, 3, 4, 5 ] }
    ...
    console.log({ myArray14: myArray14 }); // { myArray14: [ 1, 2, 3, 4, 5 ] }
    console.log(typeof myArray14); // object
    // Ok
    clearArray(myArray14);
    myArray14.push("a", "b", "c");
    console.log({ myArray14: myArray14 }); // { myArray14: [ 'a', 'b', 'c' ] }
    console.log(typeof myArray14); // object
    // Ok
    clearArray(myArray14);
    myArray14.push(1, 2, 3, "a", "b", "c");
    console.log({ myArray14: myArray14 }); // { myArray14: [ 1, 2, 3, 'a', 'b', 'c' ] }
    console.log(typeof myArray14); // object
