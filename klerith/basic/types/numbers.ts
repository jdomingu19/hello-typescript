...
(() => {
  ...
  const myTypedNumber: number = 42;

  console.log({ myTypedNumber }); // { myTypedNumber: 42 }
  console.log(typeof myNumber); // number
  ...
  console.log({ someUndefinedValue }); // { someUndefinedValue: undefined }
  console.log(typeof someUndefinedValue); // undefined

  const userNumber: number = 42;

  console.log({ userNumber }); // { userNumber: 42 }
  ...
  let absoluteNumber: number = 26;

  console.log({ absoluteNumber }); // { absoluteNumber: undefined }
  console.log(typeof absoluteNumber); // number

  if (absoluteNumber < userNumber) {
    // On the .js file it outputs "26 is less than 42"
    console.log(`${absoluteNumber} is less than ${userNumber}`);
  } else {
    console.log(`${absoluteNumber} is greater than ${userNumber}`);
  }
  ...
  let objectNumber: number = Number("42");

  console.log({ objectNumber }); // { objectNumber: 42 }
  ...
  let nanNumber: number = Number("42abc");

  console.log({ nanNumber }); // { nanNumber: NaN }
