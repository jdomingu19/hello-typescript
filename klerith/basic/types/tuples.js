...
(function () {
    ...
    console.log({ tupleArray1: tupleArray1 }); // { tupleArray1: [ 'Link', 21 ] }
    console.log(typeof tupleArray1); // object
    // Ok: reassigning values with correct types
    tupleArray1[0] = "Hero of Time";
    tupleArray1[1] = 22;
    console.log({ tupleArray1: tupleArray1 }); // { tupleArray1: [ 'Hero of Time', 22 ] }
    console.log(typeof tupleArray1); // object
    // Type mismatch
    ...
    console.log({ tupleArray2: tupleArray2 }); // { tupleArray2: [ 'Link', 21, false ] }
    console.log(typeof tupleArray2); // object
    // Ok: reassigning values with correct types
    tupleArray2[0] = "Hero of Time";
    tupleArray2[1] = 22;
    tupleArray2[2] = true;
    console.log({ tupleArray2: tupleArray2 }); // { tupleArray2: [ 'Hero of Time', 22, true ] }
    console.log(typeof tupleArray2); // object
    // Type mismatch
