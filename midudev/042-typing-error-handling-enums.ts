...
// 042 Error Handling with Enums

(() => {
  // 1. Define enum for error types (recommended for external consumption)
  enum ERROR_TYPES {
    NOT_FOUND,
    UNAUTHORIZED,
    FORBIDDEN,
  ...
  // 2. Function checking error type against enum values
  ...
  // 3. Valid calls with enum values
