...
// 044 Error Handling with String Enums

// 1. Define string enum for error types (recommended for external consumption)
enum ERROR_TYPES {
  NOT_FOUND = "notFound",
...
// 2. Function checking error type against string enum values
...
// 3. Valid calls with string enum values
